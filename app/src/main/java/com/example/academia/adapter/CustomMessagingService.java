...
*/
    ...
    public void notificationActions(Map<String,String> dataMap)
    {
        ...
        builder3.setSmallIcon(R.drawable.gfg)
                .setContentTitle(title)
                .setContentText(message)
                .setColor(Color.BLUE)
                .setSound(defaultSoundUri)
    ...
    public void directReply(Map<String,String> dataMap)
    {
        ...
        builder4 .setSmallIcon(R.drawable.gfg)
                .setContentTitle(title)
                .setContentText(message)
                .setAutoCancel(true)
                .setSound(defaultSoundUri)
    ...
    public void messageTypeNotification(Map<String,String> dataMap)
    {
        ...
        builder6.setSmallIcon(R.drawable.gfg)
                .setColor(Color.RED)
                .setLargeIcon(BitmapFactory.decodeResource(getResources(), R.drawable.gfg))
                .setSound(defaultSoundUri)
                .setStyle(style)
                .setAutoCancel(true);
        builder6.build();
